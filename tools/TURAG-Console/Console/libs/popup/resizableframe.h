#ifndef TURAG_CONSOLE_CONSOLE_LIBS_POPUP_RESIZABLEFRAME_H
#define TURAG_CONSOLE_CONSOLE_LIBS_POPUP_RESIZABLEFRAME_H
...
#endif // TURAG_CONSOLE_CONSOLE_LIBS_POPUP_RESIZABLEFRAME_H
