...
protected:
    virtual TURAG::Feldbus::BootloaderAvrBase::ErrorCode doFlashImage(uint8_t* data, uint32_t offset, uint32_t length) override;
    virtual TURAG::Feldbus::BootloaderAvrBase::ErrorCode doVerifyImage(uint8_t* data, uint32_t offset, uint32_t length) override;
