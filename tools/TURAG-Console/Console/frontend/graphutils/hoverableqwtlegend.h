#ifndef TURAG_CONSOLE_CONSOLE_FRONTEND_GRAPHUTILS_HOVERABLEQWTLEGEND_H
#define TURAG_CONSOLE_CONSOLE_FRONTEND_GRAPHUTILS_HOVERABLEQWTLEGEND_H
...
#endif // TURAG_CONSOLE_CONSOLE_FRONTEND_GRAPHUTILS_HOVERABLEQWTLEGEND_H
