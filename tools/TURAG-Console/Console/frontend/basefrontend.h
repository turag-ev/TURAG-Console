#ifndef TURAG_CONSOLE_CONSOLE_FRONTEND_BASEFRONTEND_H
#define TURAG_CONSOLE_CONSOLE_FRONTEND_BASEFRONTEND_H
...
#endif // TURAG_CONSOLE_CONSOLE_FRONTEND_BASEFRONTEND_H
